...
def _write_json(path: Path, payload: dict[str, object]) -> None:
    ...
    if path.exists():
        ...
        # Retry timestamps are operational metadata; the frozen selection is not.
...
def _publish_stage(
    *,
    ...
    try:
        ...
        # A projection outage must not discard the locally frozen selection.
        # Paper authorization still requires real Feishu receipts downstream.
        feishu_failed = True
    stage_title = {
